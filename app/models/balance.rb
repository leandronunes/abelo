...
class Balance < ActiveRecord::Base
  ...
  def validate
    ...
    self.errors.add(:date, I18n.t(:you_cant_have_two_balances_created_for_a_month)) if self.new_record? and Balance.exists?(:date => (start_date..end_date), :bank_account_id => self.bank_account)
  end
