...
require 'stock_devolution_controller'

# Re-raise errors caught by the controller.
class StockDevolutionController; def rescue_action(e) raise e end; end

class StockDevolutionControllerTest < Test::Unit::TestCase

  under_organization :one

  def setup
    @controller = StockDevolutionController.new
  ...
  def create_stock
    StockDevolution.create!(:amount => 1, :product => @product, :date => Date.today)
  end
